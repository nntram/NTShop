...
const ChangePassword = () => {
    ...
    const passwordRef3 = useRef(null);
                ...
                <Container>
                    <Row>
                        <Col lg="6" className="m-auto">
                            <h3 className="fw-bold mb-4 text-center auth__title">Đổi mật khẩu</h3>
                            ...
                            <AvGroup>
                                    ...
                                    <div className="position-relative">
                                        <AvField name="CurrentPassword" type="password"
                                            innerRef={passwordRef3}
                                        ...
                                        <i className="ri-eye-close-line signup__eye__button"
                                            ref={eyeRef3} onClick={() => eyeToggle(eyeRef3, passwordRef3)}></i>
                                    </div>
                                </AvGroup>
                                <AvGroup>
                                    <Label className="text-right text-white mx-2">
                                    ...
                                    <div className="position-relative">
                                        <AvField name="NewPassword" type="password"
                                ...
                                <AvGroup >
                                    ...
                                    <div className="position-relative">
                                        <AvField name="NewPassword2" type="password"
                                            innerRef={passwordRef2}
                                            placeholder="Nhập lại mật khẩu"
                                            validate={{
                                                match: { value: 'NewPassword', errorMessage: 'Mật khẩu không trùng khớp' },
                                                required: { value: true, errorMessage: 'Vui lòng điền đầy đủ thông tin' },
                                                maxLength: { value: 128, errorMessage: 'Quá độ dài cho phép' },
                                            }}
                                        />
